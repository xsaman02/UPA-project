...
INSERT INTO Station(WMO_ID, Latitude, Longitude, TemperatureMedian, TemperatureNightMedian, TemperatureDayMedian, HumidityMedian, RainfallMedian)
             VALUES (0, 100.12, -56.378, 28.7, 22.5, 27.9, 37.6, 2);
INSERT INTO Station(WMO_ID, Latitude, Longitude, TemperatureMedian, TemperatureNightMedian, TemperatureDayMedian, HumidityMedian, RainfallMedian)
             VALUES (1, 56098.1789, -523326.371318, 30.0, 23.8, 29.4, 25.6, 0.0);
INSERT INTO Station(WMO_ID, Latitude, Longitude, TemperatureMedian, TemperatureNightMedian, TemperatureDayMedian, HumidityMedian, RainfallMedian)
             VALUES (2, -1265, -16131.3578, 25.3, 19.8, 24.2, 57, 12.7);
INSERT INTO Station(WMO_ID, Latitude, Longitude, TemperatureMedian, TemperatureNightMedian, TemperatureDayMedian, HumidityMedian, RainfallMedian)
             VALUES (3, -0.1312, 12156.378, 34.5, 27.1, 33.9, 15.6, 0.2);
